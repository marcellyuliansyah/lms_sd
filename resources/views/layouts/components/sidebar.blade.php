...
<aside class="main-sidebar primary elevation-4">

    {{-- Brand Logo --}}
    <a href="{{ url('/') }}" class="brand-link text-decoration-none">
        <img src="{{ asset('assets/logo_sdi.PNG') }}" alt="Logo SDI"
            class="brand-image img-circle elevation-3" style="opacity: 0.8">
        <div class="brand-text-container">
            <span class="brand-text">LMS SDI</span>
            <small class="brand-subtitle">Tompokersan</small>
        </div>
    </a>
...
<style>
    .main-sidebar {
        background: linear-gradient(180deg, #479D78 0%, #3d8466 100%) !important;
        width: 250px;
